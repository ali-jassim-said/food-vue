<template>
    <section class="section-meals" id="meals">
      ...
      <div class="container grid grid--3-cols margin-bottom-md">
        <div class="meal">
          <img src="../img/meals/meal-1.jpg" class="meal-img" alt="">
            <div class="meal-content">
              ...
              <ul class="meal-attributes">
                ...
                <li class="meal-attribute"><ion-icon class="meal-icon" name="star-outline"></ion-icon><span>Average rating: <strong>4.9</strong></span></li>
              </ul>
            </div>
        </div>
        <div class="meal">
          <img src="../img/meals/meal-2.jpg" class="meal-img" alt="">
            <div class="meal-content">
              <div class="tag-meal">
              ...
              <ul class="meal-attributes">
                ...
                <li class="meal-attribute"><ion-icon class="meal-icon" name="star-outline"></ion-icon><span>Average rating: <strong>4.8</strong></span></li>
              </ul>
            </div>
        </div>
        
        <div class="diets">
          <h3 class="heading-tertairy">works with any diet:</h3>
          <ul class="list">
